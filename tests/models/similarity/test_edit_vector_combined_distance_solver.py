...
from oov.models.similarity.edit_vector_combined_distance_solver import (
    EditVectorCombinedDistanceSolver)
from overrides import overrides


class TestEditVectorCombinedDistanceSolver(OOVTestCase):
    @overrides
    def setUp(self):
        super(TestEditVectorCombinedDistanceSolver, self).setUp()
        ...
        self.model = EditVectorCombinedDistanceSolver()
