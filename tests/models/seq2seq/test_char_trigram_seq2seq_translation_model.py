...
from oov.models.seq2seq.char_trigram_seq2seq_translation_model import (
    CharTrigramSeq2SeqTranslationModel)
from overrides import overrides


class TestCharTrigramSeq2SeqTranslationModel(OOVTestCase):
    @overrides
    def setUp(self):
        super(TestCharTrigramSeq2SeqTranslationModel, self).setUp()
        self.batch_size = 3
        self.embed_dim = 4
        self.rnn_dim = 6
        self.num_layers = 2
        self.output_projection_batch_size = 2
        self.model = CharTrigramSeq2SeqTranslationModel(
    ...
    def test_train_and_load_gives_identical_results(self):
        ...
        self.model.train_model(save_dir=self.language_pair_word_translation_save_dir,
                               ...
                               run_id="char_trigram_seq2seq_unit_test",
                               num_epochs=num_epochs, show_progbar=False, **read_data)
        ...
        last_checkpoint_path = os.path.join(
            ...
            "char_trigram_seq2seq_unit_test-step-{}.ckpt".format(self.model.global_step))
    ...
    def test_training_after_loading(self):
        ...
        loaded_model.train_model(
            ...
            log_dir=self.language_pair_word_translation_log_dir,
            log_period=3, val_period=3, run_id="char_trigram_seq2seq_unit_test",
