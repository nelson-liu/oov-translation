...
from oov.models.seq2seq.morph2char_translation_model import (
    Morph2CharTranslationModel)
from overrides import overrides


class TestMorph2CharTranslationModel(OOVTestCase):
    @overrides
    def setUp(self):
        super(TestMorph2CharTranslationModel, self).setUp()
        self.batch_size = 3
        self.embed_dim = 4
        self.rnn_dim = 6
        self.num_layers = 2
        self.output_projection_batch_size = 2
        self.model = Morph2CharTranslationModel(
    ...
    def test_train_and_load_gives_identical_results(self):
        ...
        self.model.train_model(save_dir=self.language_pair_word_translation_save_dir,
                               ...
                               run_id="morph2char_unit_test", show_progbar=False,
        ...
        last_checkpoint_path = os.path.join(
            ...
            "morph2char_unit_test-step-{}.ckpt".format(self.model.global_step))
    ...
    def test_training_after_loading(self):
        ...
        loaded_model.train_model(
            ...
            log_dir=self.language_pair_word_translation_log_dir,
            log_period=3, val_period=3, run_id="morph2char_unit_test",
